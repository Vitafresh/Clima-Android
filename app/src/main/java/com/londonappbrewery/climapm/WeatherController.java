...
//    private final String LOCATION_PROVIDER = LocationManager.NETWORK_PROVIDER;    //On phisical device more quick search of location
    ...
    LocationManager mLocationManager;   //Component to start or stop requesting location updates
    LocationListener mLocationListener; //Component that will be notified if the location changed
